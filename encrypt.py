...
def IP_Decipher(IP_text) -> str:
    # 逆IP置换
    de_ip_table = [
        40, 16, 56, 24, 64, 32, 8, 48,
        47, 15, 55, 23, 63, 31, 7, 39,
        46, 14, 54, 22, 62, 30, 6, 38,
        45, 13, 53, 21, 61, 29, 5, 37,
        44, 12, 52, 20, 60, 28, 4, 36,
        43, 11, 51, 19, 59, 27, 3, 35,
        42, 10, 50, 18, 58, 26, 2, 34,
        41, 9, 49, 17, 57, 25, 1, 33
    ]
